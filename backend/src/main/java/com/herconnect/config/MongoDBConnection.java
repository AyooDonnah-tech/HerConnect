...
public class MongoDBConnection {
    ...
    private static final String DATABASE_NAME = "herconnect";
    ...
    public static synchronized MongoDatabase getDatabase() {
        if (mongoClient == null) {
            ...
            if (connStr == null || connStr.isEmpty()) {
                ...
                connStr = " mongodb+srv://Variandn04_db_user:herconnect@herconnect123.wix9jpp.mongodb.net/?appName=herconnect";
            }
        ...
        // Create unique indexes once (for email uniqueness)
        if (!indexesCreated) {
            try {
